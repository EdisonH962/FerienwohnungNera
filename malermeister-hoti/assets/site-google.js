/* Preserve MALERMEISTER HOTI's own Places configuration. Never borrow another business's key. */
(() => {
  'use strict';
  ...
  function render(place) {
    ...
    (place.photos || []).slice(0,config.maxPhotos || 10).forEach((photo,i) => {
      ...
      img.alt = 'Besim Hoti Malermeisterfachbetrieb – Foto ' + (i+1) + ' aus dem Google-Unternehmensprofil';
